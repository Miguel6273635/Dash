sap.ui.define([
  ...
  return Controller.extend("mantenimiento.controller.AnalisisReparacionesPlaneadasNoEjecutadas", {

    onInit: function () {
      var oData = this._getMockData();
      this.getView().setModel(new JSONModel(oData), "otpe");

      console.group("ANÁLISIS REPARACIONES PLANEADAS NO EJECUTADAS - MOCK");
    ...
    onApplyFilters: function () {
      ...
      console.group("FILTROS - REPARACIONES PLANEADAS NO EJECUTADAS");
    ...
    onSelectNoEjecutadas: function () {
      MessageToast.show("Ya estás viendo las reparaciones planeadas no ejecutadas.");
    },

    onSelectEjecutadas: function () {
      var oRouter = this.getOwnerComponent().getRouter();

      if (oRouter.getRoute("RouteAnalisisReparacionesPlaneadasEjecutadas")) {
        oRouter.navTo("RouteAnalisisReparacionesPlaneadasEjecutadas");
        return;
      }

      MessageToast.show("Falta registrar RouteAnalisisReparacionesPlaneadasEjecutadas en el manifest.");
    },

    onSelectTodas: function () {
      MessageToast.show("Vista de todas las reparaciones pendiente de conectar.");
    },
