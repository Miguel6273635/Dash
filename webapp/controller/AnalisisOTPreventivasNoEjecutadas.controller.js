    ...
    return Controller.extend(
        "mantenimiento.controller.AnalisisOTPreventivasNoEjecutadas",
        {
            ...
            onInit: function () {
                ...
                this._aAllCauses =
                    this._clone(oInitialData.causes);
            },
            ...
            onSearchCause: function (oEvent) {
                ...
                var sSearch =
                    this._normalizeText(sValue);

                var aCauses;

                if (!sSearch) {
                    aCauses =
                        this._clone(this._aAllCauses);
                } else {
                    aCauses =
                        this._aAllCauses.filter(
                            function (oCause) {
                                return this
                                    ._normalizeText(oCause.name)
                                    .includes(sSearch);
                            }.bind(this)
                        );
                }
            ...
            onToggleCause: function (oEvent) {
                ...
                var oModel =
                    this.getView().getModel("otne");

                var oContext =
                    oButton.getBindingContext("otne");
            ...
            _getInitialData: function () {
                return {
                    ...
                    kpis: {
                        ...
                        planeadasLabel:
                            "Planeadas",
                        planeadasDescription:
                            "Órdenes del periodo",

                        ejecutadas: 248,
                        ejecutadasLabel:
                            "Ejecutadas",
                        ejecutadasDescription:
                            "95.4% del total",
