sap.ui.define([
    ...
    return Controller.extend("mantenimiento.controller.DetalleHorasTipoOrden", {
        onInit: function () {
            ...
            this._requestId = 0;
            this._allOrders = [];
            this._filters = { periodo: initialPeriod.year, fechaDesde: initialPeriod.startDisplay, fechaHasta: initialPeriod.endDisplay, zona: "TODOS", supervisor: "TODOS", turno: "TODOS", tipoOrden: "SM01", estado: "TODOS" };
            this._loadStyles();
