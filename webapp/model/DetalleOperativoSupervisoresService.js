sap.ui.define(["mantenimiento/model/DetalleOperativoSupervisoresMapper"], function (Mapper) {
    "use strict";
    ...
    function empty() { return { resources: [], assignments: [], operations: [], orders: [], catalogs: [], meta: { unavailableEntitySets: [] } }; }
